 ...
 * @Description: 字符串的工具类
 * @author: 23663
 * @date: 2020年3月30日 下午1:47:22
 */
public class StringUtil {
	//方法1：判断源字符串是否有值，空引号(空白字符串)也算没值 (5分)
	public static boolean hasLength(String src){
		return !src.equals("")&&src.length()>0;
	}
	//方法2：判断源字符串是否有值，空引号(空白字符串)和空格也算没值 (5分)
	public static boolean hasText(String src){
		return !src.equals("")&&src.length()>0&&src.trim().length()>0;
	}
	//返回所有中文的方法
	public static String randomChineseString() throws UnsupportedEncodingException {
		...
		highCode = (176+Math.abs(random.nextInt(39)));//bo+0——39 一级汉子
		lowCode = (161+Math.abs(random.nextInt(93)));//A1+0——93 每区有93个汉子
		byte[] b = new byte[2];
	...
	public static String generateChineseName() throws UnsupportedEncodingException{
		...
		String name=str[RandomUtil.random(0, str.length-1)];
